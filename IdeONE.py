...
class Scrape:
    ...
    def getjson(self):
        ...
        r=s.post("https://ideone.com/ideone/Index/submit/",data=encodedData,headers=h,allow_redirects=True)#collect other cookies
        ...
        self.json=r.content#watch out for all redirects ,since there might be intermediate redirects where cookies are set and receives
        #for the next consequent request
        #basically,cover all "OTHER" parameters
         #can do php custom errors or manually
